...
<div class="container-fluid">
	<div class="col-lg-12">
		<form id="manage-movie">
			...
			<div class="form-group">
				<label for="" class="control-label">YouTube Trailer Link</label>
				<input name="trailer_yt_link" id="" type="text" class="form-control" value="<?php echo isset($meta['trailer_yt_link']) ? $meta['trailer_yt_link'] : '' ?>" placeholder="https://www.youtube.com/watch?v=...">
			</div>
			<div class="form-group">
